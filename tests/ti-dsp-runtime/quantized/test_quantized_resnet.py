...
Tests INT8 quantized ResNet-18 on DSP comparing against PyTorch reference.

Usage:
    pytest test_quantized_resnet.py -v --dsp-mode=c7x_host
    pytest test_quantized_resnet.py -v --dsp-mode=c7x_host --mmalib
    pytest test_quantized_resnet.py -v --dsp-mode=c7x_dload
    python test_quantized_resnet.py --dsp-mode c7x_host
"""
...
from model_utils import create_quantized_resnet_model
...
def main():
    ...
    print(f"Quantized ResNet-18 DSP Test (mode: {args.dsp_mode})")
    results = _run_test(
