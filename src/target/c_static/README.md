...
See [`src/runtime/ti_dsp/README.md`](../../runtime/ti_dsp/README.md) for
the full API reference, memory architecture, build instructions, and
...
heap (128 MB), and the firmware's TVM model manager locates the weights
...
See `docs/design_docs/c7x_dma_tiling.md` for the full investigation
log, pass-by-pass bisection evidence, and Hexagon comparison.
